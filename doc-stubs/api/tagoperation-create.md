...
-->
``` http
POST ** Collection URI for microsoft.graph.tagOperation not found
```
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.graph.tagOperation not found
